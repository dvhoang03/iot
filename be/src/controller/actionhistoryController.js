// constconst client = require('../model/mqttConn');
...
let getdata = (req, res) => {
    ...
    const query = 'SELECT * FROM actionhistory ORDER BY timestamp ASC LIMIT ? OFFSET ?';
    ...
    db.query(query, [pageSize, offset], (err, results) => {
        ...
        const countQuery = 'SELECT COUNT(*) AS total FROM actionhistory';
